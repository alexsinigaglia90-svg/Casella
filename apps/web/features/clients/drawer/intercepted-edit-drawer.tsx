 ...
 *
 * Mirrors `<ClientDrawer>` chrome (right-aligned full-height dialog) so the
 ...
 */
export function InterceptedEditDrawer({
  client,
}: {
  ...
  return (
    <Dialog open onOpenChange={handleOpenChange}>
      ...
      >
        <DialogTitle className="sr-only">{client.name} bewerken</DialogTitle>
